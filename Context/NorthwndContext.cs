...
namespace EFCoreEgitimi.Context;

/*Bu context dbfirst yaklasımı ile olustuurlmustur. Dbfirst de 
 
Scaffold-DbContext "[Connections String]" -o [Ilgili Output klasorleri]

seklinde bir komut kullanılır.  */
public partial class NorthwndContext : DbContext//DbContext db nin ta kendisini modeller. DbContext sınıfından kalıtıım zorunludur.
{
    ...
    /*Her bir dbset, db deki tabloyu temsil eder. Aldıgı sablon sınıflar ise birer entity dir. Bir sınıfın entity olabilme sartıda zaten 
    bir dbset ile bir db ye aktarılma durumudur. Bunun dısındaki class lar entity seklinde isimlendirilmez.*/
    ...
    {
        //Ilgili yaklasımın butun konfigurasyonları burada yapılır.
         optionsBuilder.UseSqlServer("Data Source=HASANHELVALI; Initial Catalog=NORTHWND; Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False;");
    }
